...
// Initialize control listeners - improved implementation
function initControlListeners() {
  ...
  allButtons.forEach(button => {
    button.addEventListener('click', function(e) {
      ...
      if (!aberrationType) {
        console.error('Button missing data-type attribute:', this);
        return;
      }
...
function updateVisualizations() {
  console.log('Updating visualizations with aberration type:', window.aberrationState.currentAberration, 
